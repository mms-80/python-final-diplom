...
### Основные результаты выполнения дипломного проекта
...
* доработан проект описания и тестирования REST API в Postman (для демонстрации работы приложения)
* реализация автогенерация документации Open API с помощью DRF-Spectacular и Swagger-UI (для документирования API и демонстрации работы приложения)
* реализован  простой DRF тротлинг
* расширение возможностей админки Django за счет использования библиотеки Jet (django-jet-reboot)
* реализован перехват ошибок с помощью Sentry
* реализовано кэширование запросов к БД с использованием Redis
* изучена библиотеки Silk для анализа выполнения запросов к БД
...
```
git clone git@github.com:SirDmitriyS/python-final-diplom.git
```
...
#### 4. После успешного запуска docker-compose приложение готово к использования по следующим ссылкам:
...
http://127.0.0.1:8000/api/schema/redoc - документация на REST API в формате Open API

### Документация на REST API

https://www.postman.com/sirdmitriys/workspace/sds-py-diplom
